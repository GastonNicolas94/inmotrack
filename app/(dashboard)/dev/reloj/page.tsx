...
import { relojPruebasHabilitado, TEST_CLOCK_COOKIE } from "@/lib/reloj-pruebas";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
          Simulá el paso del tiempo y ejecutá el cierre de períodos sin cambiar variables de Vercel ni esperar meses reales.
        </p>
      </div>
